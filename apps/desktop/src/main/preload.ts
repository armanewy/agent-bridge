...
const api: AgentBridgeApi = {
  ...
  getPlannerMode: () => ipcRenderer.invoke("agentbridge:getPlannerMode"),
  setPlannerMode: (mode) => ipcRenderer.invoke("agentbridge:setPlannerMode", mode),
  listPlannerModes: () => ipcRenderer.invoke("agentbridge:listPlannerModes"),
  getActivePlannerProvider: () => ipcRenderer.invoke("agentbridge:getActivePlannerProvider"),
