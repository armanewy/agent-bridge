...
const api = {
  ...
  listAgentTurns: (sessionRefId) => ipcRenderer.invoke("agentbridge:listAgentTurns", sessionRefId),
  ...
  createLink: (input) => ipcRenderer.invoke("agentbridge:createLink", input),
  previewHandoff: (input) => ipcRenderer.invoke("agentbridge:previewHandoff", input),
  revalidateTarget: (target) => ipcRenderer.invoke("agentbridge:revalidateTarget", target),
  configureCodexTarget: (repoPath, commands) => ipcRenderer.invoke("agentbridge:configureCodexTarget", repoPath, commands),
  deliverToCodex: (input) => ipcRenderer.invoke("agentbridge:deliverToCodex", input),
  deliverHandoffCardToCodex: (input) => ipcRenderer.invoke("agentbridge:deliverHandoffCardToCodex", input),
  ...
  configureNativeHost: (input) => ipcRenderer.invoke("agentbridge:configureNativeHost", input),
  connectChrome: (input) => ipcRenderer.invoke("agentbridge:connectChrome", input),
