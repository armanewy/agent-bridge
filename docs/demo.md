...
5. In Inbox, use the demo capture or capture selected browser text.
6. Click `Create Task Card`.
7. Review the Task Card Preview.
...
6. Confirm the latest capture appears in Inbox.
