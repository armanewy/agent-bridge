...
type RedactionPattern = {
  ...
  recommendation: RedactionFinding["recommendation"];
  pattern: RegExp;
};
...
export function detectRedactions(text: string): RedactionFinding[] {
...
export function applyRedactions(text: string, findings: RedactionFinding[]): string {
...
export function hasHighSeverityFinding(findings: RedactionFinding[]): boolean {
...
function removeContainedFindings(findings: RedactionFinding[]): RedactionFinding[] {
